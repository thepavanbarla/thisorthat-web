...
const TermsOfUse = () => {
  return (
    <div className="PrivacyPolicyContainer">
      <h1>Terms of Use</h1>
      <p>Updated on 2022-09-01</p>

      <h3>General Terms</h3>
      <p>
        By accessing and placing an order with This or That, you confirm that
      ...
      <p>
        Under no circumstances shall This or That team be liable for any direct,
        ...
        inability to use, the materials on this site, even if This or That team
      ...
      <p>
        This or That will not be responsible for any outcome that may occur
      ...
      <h3>License</h3>
      <p>
        This or That grants you a revocable, non-exclusive, non-transferable,
        limited license to download, install and use the app strictly in
        accordance with the terms of this Agreement.
      </p>
      <p>
        These Terms & Conditions are a contract between you and This or That
        (referred to in these Terms & Conditions as "This or That", "us", "we"
        or "our"), the provider of the This or That website and the services
        accessible from the This or That website (which are collectively
        referred to in these Terms & Conditions as the "This or That Service").
      </p>
      <p>
        You are agreeing to be bound by these Terms & Conditions. If you do not
        agree to these Terms & Conditions, please do not use the This or That
      ...
      <ul>
        ...
        <li>
          ...
          refers to This or That, 137-C 18th Cross, 30th Main Sector-2, HSR
          Layout Bangalore, India that is responsible for your information under
          this Terms & Conditions.
        </li>
        <li>
          Country: where This or That or the owners/founders of This or That are
          based, in this case is IN
        </li>
        <li>
          Device: any internet connected device such as a phone, tablet,
          computer or any other device that can be used to visit This or That
          and use the services.
        </li>
        <li>
          Service: refers to the service provided by This or That as described
        ...
        <li>
          Website: This or That's site, which can be accessed via this URL:{" "}
        </li>
        <li>
          You: a person or entity that is registered with This or That to use
          the Services.
        </li>
      </ul>
      ...
      <ul>
        ...
        <li>
          ...
          of copyright or trademark) of This or That or its affiliates,
          partners, suppliers or the licensors of the app.
        </li>
      </ul>
      <h3>Return and Refund Policy</h3>
      <p>
        Thanks for shopping at This or That. We appreciate the fact that you
      ...
      <p>
        ...
        apply to transactions at This or That. We’ll be as brief as our
        attorneys will allow. The main thing to remember is that by placing an
        order or making a purchase at This or That, you agree to the terms along
        with This or That's Privacy Policy.
      </p>
      <p>
      ...
      <p>
        ...
        (collectively, "Suggestions") provided by you to This or That with
        respect to the app shall remain the sole and exclusive property of This
        or That.
      </p>
      <p>
        This or That shall be free to use, copy, modify, publish, or
      ...
      <p>
        ...
        contain links to other websites not operated or controlled by This or
        That. We are not responsible for the content, accuracy or opinions
      ...
      <h3>Cookies</h3>
      <p>
        This or That uses "Cookies" to identify the areas of our website that
      ...
      <p>
        You acknowledge and agree that This or That may stop (permanently or
        temporarily) providing the Service (or any features within the Service)
        to you or to users generally at This or That’s sole discretion, without
        prior notice to you. You may stop using the Service at any time. You do
        not need to specifically inform This or That when you stop using the
        Service. You acknowledge and agree that if This or That disables access
      ...
      <p>
        This or That reserves the right to modify, suspend or discontinue,
      ...
      <p>
        This or That may from time to time provide enhancements or improvements
        to the features/ functionality of the app, which may include patches,
      ...
      <p>
        ...
        the app. You agree that This or That has no obligation to (i) provide
      ...
      <p>
        You acknowledge and agree that This or That shall not be responsible for
        ...
        or any other aspect thereof. This or That does not assume and shall not
      ...
      <p>
        This Agreement shall remain in effect until terminated by you or This or
        That.
      </p>
      <p>
        This or That may, in its sole discretion, at any time and for any or no
      ...
      <p>
        ...
        This or That, in the event that you fail to comply with any provision of
      ...
      <p>
        Termination of this Agreement will not limit any of This or That's
      ...
      <p>
        You agree to indemnify and hold This or That and its parents,
      ...
      <p>
        ...
        permitted under applicable law, This or That, on its own behalf and on
        ...
        implied, statutory or otherwise, with respect to the app, including all
        ...
        limitation to the foregoing, This or That provides no warranty or
      ...
      <p>
        Without limiting the foregoing, neither This or That nor any This or
        That's provider makes any representation or warranty of any kind,
        express or implied: (i) as to the operation or availability of the app,
        or the information, content, and materials or products included thereon;
        (ii) that the app will be uninterrupted or error-free; (iii) as to the
        ...
        content, or e-mails sent from or on behalf of This or That are free of
      ...
      <p>
        ...
        of This or That and any of its suppliers under any provision of this
      ...
      <p>
        ...
        This or That or its suppliers be liable for any special, incidental,
        ...
        Agreement), even if This or That or any supplier has been advised of the
      ...
      <p>
        ...
        notices published by This or That on the Services, shall constitute the
        entire agreement between you and This or That concerning the Services.
        ...
        any other term, and This or That's failure to assert any right or
        provision under this Agreement shall not constitute a waiver of such
        right or provision. YOU AND This or That AGREE THAT ANY CAUSE OF ACTION
      ...
      <p>
        This or That reserves the right, at its sole discretion, to modify or
      ...
      <p>
        ...
        agree to the new terms, you are no longer authorized to use This or
        That.
      </p>

      <h3>Entire Agreement</h3>
      <p>
        The Agreement constitutes the entire agreement between you and This or
        That regarding your use of the app and supersedes all prior and
        contemporaneous written or oral agreements between you and This or That.
      </p>
      <p>
        You may be subject to additional terms and conditions that apply when
        you use or purchase other This or That's services, which This or That
      ...
      <p>
        ...
        owned by This or That, its licensors or other providers of such material
        and are protected by IN and international copyright, trademark, patent,
        ...
        written permission of This or That, unless and except as is expressly
      ...
      <p>
        ...
        ENFORCEMENT OR VALIDITY OF YOUR OR This or That's INTELLECTUAL PROPERTY
        RIGHTS. The term “dispute” means any dispute, action, or other
        controversy between you and This or That concerning the Services or this
      ...
      <p>
        In the event of a dispute, you or This or That must give the other a
        ...
        <a
          ...
          class="__cf_email__"
          data-cfemail="0263666f6b6c42726b6169766a6b716d70766a63762c616d6f2c"
        >
          [email&#160;protected]
        </a>{" "}
        This or That will send any Notice of Dispute to you by mail to your
        address if we have it, or otherwise to your email address. You and This
        or That will attempt to resolve any dispute through informal negotiation
        within sixty (60) days from the date the Notice of Dispute is sent.
        After sixty (60) days, you or This or That may commence arbitration.
      </p>

      <h3>Binding Arbitration</h3>
      <p>
        If you and This or That don’t resolve any dispute by informal
      ...
      <p>
        ...
        and will become the sole property of This or That without any
        compensation or credit to you whatsoever. This or That and its
      ...
      <h3>Promotions</h3>
      <p>
        This or That may, from time to time, include contests, promotions,
      ...
      <p>
        ...
        of This or That. This or That will be entitled to injunctive or other
        equitable relief (without the obligations of posting any bond or surety)
        in the event of any breach or anticipatory breach by you. This or That
        operates and controls the This or That Service from its offices in IN.
        ...
        choose to access the This or That Service from other locations do so on
        ...
        & Conditions (which include and incorporate the This or That Privacy
        Policy) contains the entire understanding, and supersedes all prior
        understandings, between you and This or That concerning its subject
      ...
      <h3>Disclaimer</h3>
      <p>
        This or That is not responsible for any content, code or any other
        imprecision.
      </p>
      <p>This or That does not provide warranties or guarantees.</p>
      <p>
        In no event shall This or That be liable for any special, direct,
      ...
      <p>
        The This or That Service and its contents are provided "as is" and "as
        available" without any warranty or representations of any kind, whether
        express or implied. This or That is a distributor and not a publisher of
        the content supplied by third parties; as such, This or That exercises
        ...
        accessible via the This or That Service. Without limiting the foregoing,
        This or That specifically disclaims all warranties and representations
        in any content transmitted on or in connection with the This or That
        Service or on sites that may appear as links on the This or That
        Service, or in the products provided as a part of, or otherwise in
        connection with, the This or That Service, including without limitation
        ...
        information given by This or That or any of its affiliates, employees,
        ...
        Without limiting the foregoing, This or That does not warrant that the
        This or That Service will be uninterrupted, uncorrupted, timely, or
        error-free.
      </p>
      ...
      <ul>
        <li>
          ...
          <a
            href="/cdn-cgi/l/email-protection"
            class="__cf_email__"
            data-cfemail="e786838a8e89a7978e848c938f8e948895938f8693c984888a"
          >
            [email&#160;protected]
          </a>
        </li>
        <li>Via Phone Number: +91 7999771781</li>
      </ul>
      <script
        data-cfasync="false"
